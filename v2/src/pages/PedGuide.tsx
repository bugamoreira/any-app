...
const TOX_DRUGS: BolusDrug[] = [
  ...
  { id: 'glucagon-tox', name:'GLUCAGON (Betabloqueador/BCC)', presentation:'1 mg/mL', doseBadge:'0,05 mg/kg',
    instruction:'Preparo: 4 mg (4 mL) + SG 5% 46 mL = 50 mL, concentração 0,08 mg/mL. Ataque max: 10 mg. Manutenção: 0,05-0,1 mg/kg/h na mesma diluição. Benefício incerto: antecipar náuseas e vômitos e discutir com o CIATox.',
    calc:p => { const d=Math.min(p*0.05,10); return { mg:fN(d,2), ml:fN(d/0.08,2), mlLabel:'da solução 0,08 mg/mL', unit:'mg' }; } },
