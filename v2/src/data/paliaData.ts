  ...
  },
  {
    ...
    content: {
      ...
      items: [
        ...
        '"Ja conversou com sua família sobre suas preferências?"',
...
export const frasesUteis: string[] = [
  ...
  '"Não vamos abandoná-lo. Estaremos cuidando dele ate o final."',
]
...
export const ppsLevels: PpsLevel[] = [
  ...
  { pps: '80%', deambulacao: 'Completa', atividade: 'Com esforco', autocuidado: 'Completo', ingesta: 'Normal ou reduzida', consciência: 'Completa' },
...
export const hipoProcedimento: TechniqueStep[] = [
  ...
  { title: 'Verificar compatibilidade', description: 'Conferir se a medicação está na lista de HDC e aprazamento compativel' },
  ...
  { title: 'Conectar medicação', description: 'Se infusão contínua: BIC ate 62,5 mL/h (noturno em coxa: 70-100 mL/h)' },
...
export const hipoMedicações: HipoMed[] = [
  ...
  { name: 'Dipirona', dose: '1-2 g ate 6/6h', dilution: 'SF 0,9% 2 mL', obs: 'Aplicação lenta em bolus' },
  { name: 'Ertapenem', dose: '1 g 24/24h', dilution: 'Reconstituir em 10 mL AD + 50 mL SF 0,9%', obs: 'Tempo de infusão: 30 min. Alternativa: bolus com 1g em 3,2 mL lidocaina 1% (sem epinefrina)' },
  { name: 'Escopolâmina', dose: '20 mg 8/8h ate 60 mg 6/6h', dilution: 'SF 0,9% 1 mL (bolus)', obs: 'Infusao em bolus ou continua. Não confundir com a apresentação combinada com dipirona' },
...
export const mythsData: MythData[] = [
  ...
  { id: 3, category: 'conceito', title: '"So para cancer"', isMito: true, statement: '"Cuidados paliativos sao apenas para pacientes oncologicos."', explanation: 'Cuidados paliativos beneficiam qualquer doença grave e ameaçadora à vida: ICC, DPOC, DRC, demencia, doenças neurologicas, fragilidade do idoso. Todas essas condições cursam com sintomas que precisam de manejo adequado.' },
  { id: 4, category: 'conceito', title: '"So no fim"', isMito: true, statement: '"Cuidados paliativos devem ser iniciados apenas nos últimos dias de vida."', explanation: 'Quanto mais precoce a integração dos cuidados paliativos, melhores os desfechos. Estudos mostram que pacientes com cancer de pulmao que receberam CP precoces viveram MAIS e com melhor qualidade de vida.' },
  ...
  { id: 9, category: 'medicações', title: '"Sedação e eutanásia"', isMito: true, statement: '"Sedação paliativa é uma forma disfarçada de eutanásia."', explanation: 'Sedação paliativa visa controlar sintomas refratários, não antecipar a morte. A intenção (alívio de sofrimento) e o método (titulação para conforto) são completamente diferentes da eutanásia.' },
  { id: 10, category: 'medicações', title: '"Dose máxima"', isMito: true, statement: '"Opioides tem dose máxima que não pode ser ultrapassada."', explanation: 'Opioides NÃO tem dose teto para analgesia. A dose correta é aquela que alivia a dor com efeitos adversos toleráveis. Pacientes em uso crônico desenvolvem tolerância e podem precisar de doses muito altas.' },
  ...
  { id: 12, category: 'medicações', title: '"So se pedir"', isMito: true, statement: '"So devo dar analgesico se o paciente pedir."', explanation: 'Muitos pacientes, especialmente idosos e com déficit cognitivo, não pedem analgesia mesmo com dor intensa. A avaliação proativa e sistemática da dor e responsabilidade da equipe.' },
  ...
  { id: 22, category: 'prognóstico', title: '"Milagre acontece"', isMito: false, statement: '"Casos excepcionais de recuperacao inesperada existem."', explanation: 'Verdade! Casos excepcionais ocorrem, mas são estatisticamente raros. Basear decisões em exceções extremas pode prolongar sofrimento desnecessáriamente para a grande maioria. Equilíbrio é fundamental.' },
  { id: 23, category: 'prognóstico', title: '"So oncologia decide"', isMito: true, statement: '"Apenas o oncologista pode indicar cuidados paliativos."', explanation: 'Qualquer medico pode identificar necessidade de cuidados paliativos e iniciar abordagem. O emergencista frequentemente e o primeiro a reconhecer e pode coordenar com equipe especializada posteriormente.' },
  { id: 24, category: 'prognóstico', title: '"Se entrar no DE, intubo"', isMito: true, statement: '"Se o paciente veio ao DE, e porque quer ser intubado e reanimado."', explanation: 'Pacientes vem ao DE por diversos motivos: dor, dispneia, medo, orientação inadequada. Vir ao DE não significa automaticamente querer medidas invasivas. Sempre verificar desejos e contexto.' },
]
